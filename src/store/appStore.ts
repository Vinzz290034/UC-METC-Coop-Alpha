...
const createDefaultProducts = (): Product[] => {
  const defaultItems = [
    ...
    { name: 'PE Pants', sku: 'UNI-005', price: 270, stock: 49, category: 'uniform', available: true, image: '', note: 'Note: Please proceed to the Coop Office if you need assistance in confirming your size.', options: [{ id: 'size', label: 'Size', choices: ['Small (₱270)', 'Medium (₱270)', 'Large (₱270)', 'XL (₱290)', '2XL (₱290)', '3XL (₱330)'] }] },
